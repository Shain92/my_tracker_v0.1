...
/// Диалог формы создания/редактирования отдела
...
class _DepartmentFormDialogState extends State<DepartmentFormDialog> {
  ...
  void initState() {
    ...
    if (widget.department != null) {
      ...
      _colorController.text = widget.department!.color;
      _selectedColor = _parseColor(widget.department!.color);
    } else {
  ...
  Future<void> _saveDepartment() async {
    ...
    if (widget.department == null) {
      ...
      result = await ApiService.createDepartment(
        name,
      ...
      result = await ApiService.updateDepartment(
